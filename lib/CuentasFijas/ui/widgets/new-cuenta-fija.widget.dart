        ...
        child: new Column(
          ...
          children: <Widget>[
            new NumberPicker.horizontal(
                initialValue: cuentaFija.dayOfPayment,
                minValue: 1,
                haptics: true,
                fontSize: 40,
                maxValue: 31,
                onChanged: (newValue) {
                  setState(() {
                    cuentaFija.dayOfPayment = newValue;
                  });
                }),
            SizedBox(
              height: 50,
            ...
            RichText(
              text: TextSpan(
                  style: TextStyle(
                      ...
                      fontFamily: 'Lato'),
                  children: [
                    TextSpan(text: 'El pago sería el '),
                    TextSpan(
                      text: cuentaFija.dayOfPayment.toString(),
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    TextSpan(text: ' de cada mes.'),
                  ]),
            ),
          ],
        ),
          ...
          RichText(
            text: TextSpan(
                style: TextStyle(
                    ...
                    fontFamily: 'Lato'),
                children: [
                  TextSpan(text: 'Escoge la fecha de '),
                  TextSpan(
                    text: "vencimiento",
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                  TextSpan(
                      text: ' que la cuenta tiene como fecha límite de pago.'),
                ]),
          ),
          SizedBox(
            height: 35,
    ...
    child: RichText(
      text: TextSpan(
          ...
          children: [
            ...
            TextSpan(text: 'es el valor de la nueva cuenta fija?'),
          ]),
    ),
  );
