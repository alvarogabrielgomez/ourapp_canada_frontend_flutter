...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle =
        themeData.textTheme.headline4.copyWith(fontSize: fontSize - 15);
    TextStyle selectedStyle = themeData.textTheme.headline4
        .copyWith(color: themeData.accentColor, fontSize: fontSize);
